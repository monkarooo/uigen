...
export default function MainContent({ user, project }: MainContentProps) {
      ...
      <ChatProvider projectId={project?.id} initialMessages={project?.messages}>
        <div className="h-screen w-screen overflow-hidden bg-neutral-50">
          <ResizablePanelGroup id="main-layout" direction="horizontal" className="h-full">
            {/* Left Panel - Chat */}
            <ResizablePanel id="panel-chat" defaultSize={35} minSize={25} maxSize={50}>
            ...
            <ResizableHandle id="handle-main" className="w-[1px] bg-neutral-200 hover:bg-neutral-300 transition-colors" />

            {/* Right Panel - Preview/Code */}
            <ResizablePanel id="panel-main" defaultSize={65}>
              <div className="h-full flex flex-col bg-white">
                {/* Top Bar */}
                ...
                <div className="flex-1 overflow-hidden bg-neutral-50">
                  {activeView === "preview" ? (
                    ...
                    >
                      ...
                      <ResizableHandle id="handle-code-editor" className="w-[1px] bg-neutral-200 hover:bg-neutral-300 transition-colors" />

                      {/* Code Editor */}
                      <ResizablePanel id="panel-code-editor" defaultSize={70}>
                        <div className="h-full bg-white">
                          <CodeEditor />
                        </div>
                      </ResizablePanel>
