              ...
              <div className={cn(
                ...
                <div className="text-sm">
                  {message.parts && message.parts.length > 0 ? (
                    <>
                      {(message.parts as UIMessagePart<UIDataTypes, UITools>[]).map((part, partIndex) => {
                        if (part.type === "text") {
                        ...
                        if (part.type === "dynamic-tool") {
                          return (
                            <ToolCallBadge key={partIndex} toolInvocation={{
                        ...
                        // Handle typed tool parts (tool-str_replace_editor, tool-file_manager, etc.)
